...
public class CodeWriter extends AbstractCodeWriter {
    ...
    private void writeBaseConfig(Map<String, String> baseConfigFiles) {
        ...
        for (Map.Entry<String, String> entry : baseConfigFiles.entrySet()) {
            ...
            if (ConstVal.TPL_JDBC.equals(key)) {
                ...
                extracted6(basePackage, template);
                Set<String> dataSourceSet = GeneratorProperties.getMultipleDataSource();
                Map<String, String> dataSourceMap = new HashMap<>();
                int i = 0;
                extracted(template, dataSourceSet, dataSourceMap, i);
	...
	private void extracted6(String basePackage, Template template) {
	...
	private void extracted2(PropertiesUtils dbProp, Template template) {
		//SpringBoot yml
	...
	private void extracted1(Template template) {
		//pom
	...
	private void extracted(Template template, Set<String> dataSourceSet, Map<String, String> dataSourceMap, int i) {
